...
| accelerationValue   | where particles are attracted                                                                                                                                                                                                  | `0, -10, 0`          |
| accelerationSpread  | how far particles are spread from center                                                                                                                                                                         | `10 0 10`            |
| velocityValue       | the speed with which particles are start moving in direction                                                                                                                                                                                                       | `0 25 0`             |
